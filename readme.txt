...
Tags: widgets to shortcode, widgets, shortcode, convert widget to shortcode, widget as shortcode.
...
This plugin will let you use any of your active widgets as a shortcode.
...
<li>Should work on all widgets</li>
</ul>

== Installation ==

1. Upload the entire `widget-to-shortcode` folder to the `/wp-content/plugins/` directory.
